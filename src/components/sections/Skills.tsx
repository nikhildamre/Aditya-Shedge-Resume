...
const Skills: React.FC = () => {
  ...
  return (
    <section
      id="skills"
      className="min-h-screen flex items-center justify-center bg-primary-100 relative overflow-hidden py-20"
    >
      <ParallaxBackground />
        ...
        >
          {skills.map((skill) => {
            ...
            return (
              ...
              >
                <div
                  className="bg-white/50 backdrop-blur-sm border border-primary-300 rounded-full p-4 shadow-sm 
                             hover:shadow-md hover:border-primary-400 transition-all duration-300 
                             hover:bg-white/80"
                >
                  <div className="text-center flex flex-col items-center space-y-2">
                    {IconComponent && (
                      <IconComponent className="w-6 h-6 md:w-8 md:h-8 text-primary-700 group-hover:text-primary-900 transition-colors duration-300" />
                    )}
                    <h3
                      className="text-sm md:text-base text-primary-800 group-hover:text-primary-900
